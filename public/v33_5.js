...
function inject(body){const p=profile(body);body.voice={...(body.voice&&typeof body.voice==='object'?body.voice:{}),adaptiveVersion:'33.5',adaptiveProfile:p,deliveryInstruction:'Use this profile to shape expression only. Never change the factual answer, invent memories, or override boundaries.'};body.behaviour={...(body.behaviour||{}),adaptiveDelivery:'33.5',adaptiveVoiceProfile:p};return body}
